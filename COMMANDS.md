...
`Jarvis Control` owner-only и не показывается обычным участникам. Команды без параметров вынесены в живые экраны панели. Команды с параметрами описаны там как готовые шаблоны использования.
