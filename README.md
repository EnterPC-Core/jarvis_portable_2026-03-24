...
Проект задуман как единая рабочая оболочка вокруг `Codex` в Telegram:
...
- запуск `Codex` из локальной среды
...
Это нужно для того, чтобы вопросы вида “погода”, “курс доллара”, “цена BTC”, “последние новости” не шли через слабый HTML-поиск.
...
- для владельца может использовать расширенный локальный режим и прямой вызов `Codex`
...
- документация ниже должна отражать именно это, а не старую облачную схему
